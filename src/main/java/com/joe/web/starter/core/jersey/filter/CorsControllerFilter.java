...
public class CorsControllerFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext)
        ...
        headers.add("Access-Control-Allow-Origin", join(prop.getAllowOrigins()));
        headers.add("Access-Control-Allow-Methods", join(prop.getAllowMethods()));
        headers.add("Access-Control-Max-Age", prop.getMaxAge());
        headers.add("Access-Control-Allow-Headers", join(prop.getAllowHeaders()));
    }
