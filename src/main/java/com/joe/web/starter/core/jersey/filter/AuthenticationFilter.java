...
import com.joe.web.starter.core.jersey.secure.AppSecurityContext;
...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        if (this.context != null) {
            User user = Optional.ofNullable(context.getUser(request)).orElse(User.createAnonymous());
            AppSecurityContext securityContext = new AppSecurityContext(user);
